...
const translations = {
  en: {
    ...
    "news.subtitle": "Stay updated with the latest news, events, and stories from our community.",
    "news.backHome": "Back to Home",
    "news.category.events": "Events",
    "news.category.support": "Support",
    "news.category.community": "Community",
    "news.category.medical": "Medical",
    "news.item1.title": "Annual Charity Gala Raises Record Funds",
    "news.item1.excerpt": "Our annual charity gala brought together over 200 supporters, raising significant funds for NICU equipment and family support programs.",
    "news.item2.title": "New Family Support Program Launched",
    "news.item2.excerpt": "We're excited to announce our new comprehensive support program designed to help families throughout their NICU journey and beyond.",
    "news.item3.title": "Volunteer Appreciation Day Celebration",
    "news.item3.excerpt": "We honored our dedicated volunteers who have contributed countless hours to supporting premature babies and their families.",
    "news.item4.title": "Partnership with Local Hospital Announced",
  ...
  lt: {
    ...
    // News Page
    "news.title": "Naujienos ir Atnaujinimai",
    "news.subtitle": "Sekite naujausias naujienas, renginius ir istorijas iš mūsų bendruomenės.",
    "news.backHome": "Grįžti į Pradžią",
    "news.category.events": "Renginiai",
    "news.category.support": "Parama",
    "news.category.community": "Bendruomenė",
    "news.category.medical": "Medicina",
    "news.item1.title": "Metinis Labdaros Renginys Surinko Rekordinę Sumą",
    "news.item1.excerpt": "Mūsų metinis labdaros renginys sukvietė daugiau nei 200 rėmėjų, surinkdamas reikšmingų lėšų intensyvios terapijos įrangai ir šeimų paramos programoms.",
    "news.item2.title": "Paleista Nauja Šeimų Paramos Programa",
    "news.item2.excerpt": "Džiaugiamės galėdami pranešti apie naują visapusišką paramos programą, skirtą padėti šeimoms per visą intensyvios terapijos kelionę ir po jos.",
    "news.item3.title": "Savanorių Padėkos Dienos Šventė",
    "news.item3.excerpt": "Pagerbėme mūsų atsidavusius savanorius, kurie skyrė nesuskaičiuojamas valandas anksčiau laiko gimusių kūdikių ir jų šeimų palaikymui.",
    "news.item4.title": "Paskelbta Partnerystė su Vietos Ligonine",
